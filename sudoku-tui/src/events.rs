...
use crate::{app_state::{App, Direction}, ui::ui};
        ...
        if let Event::Key(key) = event::read()? {
            match key.code {
                KeyCode::Char('h' | 'a') | KeyCode::Left =>
                    app.move_pos(Direction::Left),
                KeyCode::Char('j' | 's') | KeyCode::Down =>
                    app.move_pos(Direction::Down),
                KeyCode::Char('k' | 'w') | KeyCode::Up =>
                    app.move_pos(Direction::Up),
                KeyCode::Char('l' | 'd') | KeyCode::Right =>
                    app.move_pos(Direction::Right),
